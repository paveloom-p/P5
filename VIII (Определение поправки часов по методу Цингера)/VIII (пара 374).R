  ...
  B_1 = c(16.5, 22.3) # Восточная звезда, до наблюдения
  A_1 = c(15.5, 21.5) # Восточная звезда, после наблюдения
  ...
  T_E_1 = c(18,   18,   18,   18)
  T_E_2 = c(31,   30,   30,   29)
  T_E_3 = c( 5, 43.5, 22.5, 58.5)
  
  T_E_dec = T_E_1 * 15 + T_E_2 / 4 + T_E_3 / 240
  
  T_W_1 = c(  18,   18, 18, 18)
  T_W_2 = c(  25,   25, 25, 26)
  T_W_3 = c(13.5, 31.5, 56, 20)
  
  T_W_dec = T_W_1 * 15 + T_W_2 / 4 + T_W_3 / 240
  
  show_in_the_hour_system_from_dec(1 / 2 * (T_W_dec[1] + T_E_dec[4]))
  show_in_the_hour_system_from_dec(1 / 2 * (T_W_dec[1] - T_E_dec[4]))
  ...
  A_1 = mean(1 / 2 * (T_W_dec[1] + T_E_dec[4]))
  A_2 = mean(1 / 2 * (T_W_dec[1] - T_E_dec[4]))
  ...
  alpha = transfer_from_hour_system_to_dec(c(18, 23, 44.899)) # в часовой
  delta = c(30,  48,  7.24)  # в градусной
  eps   = c( 0,  29, 46.46)  # в градусной
  beta  = c( 2,  50, 1.731) # в часовой
  ...
  A_W = transfer_from_degree_system_to_dec(c(64, 23, 0))
  ...
  z = transfer_from_degree_system_to_dec(c(40, 14, 0))
