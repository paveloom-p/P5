  ...
  B_1 = c(11.2, 17.1) # Восточная звезда, до наблюдения
  A_1 = c(10.8, 16.9) # Восточная звезда, после наблюдения
  ...
  T_E_1 = c(18,   18, 18, 18,  18, 18)
  T_E_2 = c(37,   37, 37, 38,  38, 38)
  T_E_3 = c( 5, 24.5, 44,  6,  24, 43)
  
  T_E_dec = T_E_1 * 15 + T_E_2 / 4 + T_E_3 / 240
  
  T_W_1 = c(  18, 18,   18, 18)
  T_W_2 = c(  42, 42,   42, 41)
  T_W_3 = c(53.5, 32, 12.5, 52)
  
  T_W_dec = T_W_1 * 15 + T_W_2 / 4 + T_W_3 / 240
  
  show_in_the_hour_system_from_dec(1 / 2 * (T_W_dec + T_E_dec[3:6]))
  show_in_the_hour_system_from_dec(1 / 2 * (T_W_dec - T_E_dec[3:6]))
  ...
  A_1 = mean(1 / 2 * (T_W_dec + T_E_dec[3:6]))
  A_2 = mean(1 / 2 * (T_W_dec - T_E_dec[3:6]))
  ...
  alpha = transfer_from_hour_system_to_dec(c(18, 38, 42.258)) # в часовой
  delta = c(40,   3,  50.25)  # в градусной
  eps   = c( 0,  15,  19.59)  # в градусной
  beta  = c( 3,  36,  1.321) # в часовой
  ...
  A_W = transfer_from_degree_system_to_dec(c(85, 19, 0))
  ...
  z = transfer_from_degree_system_to_dec(c(38, 50, 0))
