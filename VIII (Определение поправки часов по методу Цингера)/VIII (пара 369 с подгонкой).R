  ...
  B_1 = c(16.8, 22.5) # Восточная звезда, до наблюдения
  A_1 = c(15,   29)   # Восточная звезда, после наблюдения
  ...
  T_E_1 = c(  18, 18,   18, 18,   18,   18, 18)
  T_E_2 = c(  10, 10,    9,  9,    9,    8,  8)
  T_E_3 = c(31.5, 12, 58.5, 32, 11.5, 51.5, 30)
  
  T_E_dec = T_E_1 * 15 + T_E_2 / 4 + T_E_3 / 240
  
  T_W_1 = c(  18, 18, 18, 18,   18, 18, 18)
  T_W_2 = c(   3,  5,  4,  4,    4,  5,  5)
  T_W_3 = c(38.5,  0, 20, 42, 57.5, 20, 41)
  ...
  show_in_the_hour_system_from_dec(271.7935 - 271.55345)
  ...
  alpha = transfer_from_hour_system_to_dec(c(18, 10, 12.291)) # в часовой
  delta = c(49,  48,  2.54)  # в градусной
  eps   = c(-0, -34, -40.9)  # в градусной
  beta  = c( 4,  21,  54.29) # в часовой
  ...
  A_W = transfer_from_degree_system_to_dec(c(102, 59, 0))
  ...
  z = transfer_from_degree_system_to_dec(c(37, 1, 0))
