  ...
  T_1 = c(20,   20,   20,   20,   20,   20, 20, 20)
  T_2 = c(14,   19,   23,   28,   36,   41, 45, 51)
  T_3 = c(55, 11.5, 44.5, 41.5, 37.5, 53.5, 14, 48)
  
  T_dec = T_1 * 15 + T_2 / 4 + T_3 / 240
  T_dec
  
  show_in_the_hour_system_from_dec(T_dec[4])
  
  # Табличные значения для альфа (для звезды γ Cyg) 
  # с переводом в десятичные углы (запись в виде (часы, минуты, секунды))
  
  alpha_1 = c(20, 22, 56.546)
  alpha_2 = c(20, 22, 56.745)
  ...
  delta_1 = c(40, 18, 63.43)
  delta_2 = c(40, 18, 66.53)
  ...
  L_I_y_1 = c(19, 19, 19, 19)
  L_I_y_2 = c(26, 26, 26, 26)
  L_I_y_3 = c(10, 31, 57, 44)
  ...
  L_I_o_1 = c(19, 19, 19, 19)
  L_I_o_2 = c(26, 26, 26, 26)
  L_I_o_3 = c(14, 33, 59, 44)
  ...
  L_II_y_1 = c(199, 199, 199, 199)
  L_II_y_2 = c( 26,  26,  26,  26)
  L_II_y_3 = c( 11,  32,  56,  43)
  
  L_II_y_dec = L_II_y_1 + L_II_y_2 / 60 + L_II_y_3 / 3600
  L_II_y_dec
  
  L_II_o_1 = c(199, 199, 199, 199)
  L_II_o_2 = c( 26,  26,  27,  26)
  L_II_o_3 = c( 13,  32,   0,  45)
  ...
  R_I_y_1 = c(340, 340, 340, 340)
  R_I_y_2 = c( 42,  36,  27,  19)
  R_I_y_3 = c( 36,  16,  14,   0)
  
  R_I_y_dec = R_I_y_1 + R_I_y_2 / 60 + R_I_y_3 / 3600
  R_I_y_dec
  
  R_I_o_1 = c(340, 340, 340, 340)
  R_I_o_2 = c( 42,  36,  27,  19)
  ...
  R_II_y_1 = c(160, 160, 160, 160)
  R_II_y_2 = c( 42,  36,  27,  19)
  R_II_y_3 = c( 37,  18,  13,   2)
  
  R_II_y_dec = R_II_y_1 + R_II_y_2 / 60 + R_II_y_3 / 3600
  R_II_y_dec
  
  R_II_o_1 = c(160, 160, 160, 160)
  R_II_o_2 = c( 42,  36,  27,  19)
  ...
  # Было: 19.64201
  temp_5 = 19.48
  show_in_the_degree_system(temp_5)
#  L = c(temp_5, temp_5, temp_5, temp_5)
  ...
  # Было: 339.7951
  temp_6 = 340.247
  show_in_the_degree_system(temp_6)
#  R = c(temp_6, temp_6, temp_6, temp_6)
