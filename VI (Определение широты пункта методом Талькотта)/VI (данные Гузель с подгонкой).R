...
# tau2 = 1.225 # 103
  ...
  M_north = c(8.7, 8.55, 8.7, 8.7, 8.6, 8.65)
  Mn = mean(M_north)
  Mn
  
  M_south = c(6.890, 6.960, 6.970, 7.015, 7.005, 7.000)
  Ms = mean(M_south)
  Ms
  ...
  JIuIIn = mean(c(14 + 35.5, 14 + 35.5))
  JIuIIn 
  
  JIuIIs = mean(c(10 + 31.5, 10 + 31.5))
  JIuIIs
  ...
  deltaN = c(69, 37.8, 0) # Звезда 1544 (беру значения из таблицы пар Талькотта на старую эпоху)
  ...
  deltaS = c(50, 10.7, 0) # Звезда 1549
  ...
  Fn = (445.6^2 + 296.2^2 + 144.4^2 + 150.2^2 + 298.9^2 + 451.5^2) / 825060 / (thr_num_1 + 1)
  Fn # в секундах
    
  Fs = (445.6^2 + 296.2^2 + 144.4^2 + 150.2^2 + 298.9^2 + 451.5^2) / 825060 / (thr_num_2 + 1) 
  Fs # в секудах
  ...
  # (сначала для северной звезды) 1544 / 1549
  
  mu_a_v = c(-1.743, 0.254)
  a_a_v = c(0.393, 0.411)
  b_a_v = c(0.9195, 0.9118)
  c_a_v = c(1.0128, 0.9784)
  d_a_v = c(0.3687, 0.3157)
  ...
  deltaN_now = c(69, 41, 39.80)
  deltaS_now = c(50, 16, 0.30) 
