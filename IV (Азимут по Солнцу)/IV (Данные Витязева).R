...
# Четвёртая и пятая строчки: прямые восхождения и склонения (интерполирование по табличным данным)
    ...
    alpha = M_ast * (alpha_teta_a - M_ast / 48 * alpha_teta_diff)
