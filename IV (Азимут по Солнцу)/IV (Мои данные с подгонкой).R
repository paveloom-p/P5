  ...
  show_in_the_degree_system(A_dec)
    ...
    A_dec[1] = transfer_from_degree_system_to_dec(c( -5,  -1, -37.3))
    A_dec[2] = transfer_from_degree_system_to_dec(c( -3, -20,  -5.6))
    A_dec[3] = transfer_from_degree_system_to_dec(c(-15, -52, -59.4))
    A_dec[4] = transfer_from_degree_system_to_dec(c(-13, -47, -24.2))
  ...
  # Значения уровней: (сначала все данные в левом столбце (до), потом все данные в правом столбце (после),
  # причём для обоих кругов сразу)
  ...
  # Двадцать третья строчка: delta_b
  ...
  show_in_the_hour_system_from_dec(transfer_from_hour_system_to_dec(c(24, 0, 0)) + t)
  
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(23, 25, 15.5) - transfer_from_degree_system_to_dec(c(23, 24, 30.3))))
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(23, 25, 15.0) - transfer_from_degree_system_to_dec(c(23, 24, 30.0))))
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(23, 25, 13.5) - transfer_from_degree_system_to_dec(c(23, 24, 29.0))))
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(23, 25, 13.3) - transfer_from_degree_system_to_dec(c(23, 24, 28.8))))
  
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(174, 58, 22.7)) - 180)
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(176, 39, 54.4)) - 180)
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(164,  7,  0.6)) - 180)
  show_in_the_degree_system(transfer_from_degree_system_to_dec(c(166, 12, 35.8)) - 180)
